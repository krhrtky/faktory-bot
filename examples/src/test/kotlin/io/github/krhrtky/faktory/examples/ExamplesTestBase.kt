...
abstract class ExamplesTestBase {
    ...
    fun cleanupDatabase() {
        ...
        dsl.truncate(io.github.krhrtky.faktory.examples.jooq.tables.Posts.POSTS).execute()
        dsl.truncate(io.github.krhrtky.faktory.examples.jooq.tables.Users.USERS).execute()
