...
class FactoryResolver {
    ...
    private fun <T : Record> mergeChain(chain: List<FactoryDefinition<T>>): ResolvedFactory<T> {
        val mergedAttributes = mutableMapOf<String, io.github.krhrtky.faktory.core.AttributeDefinition<*>>()
        var mergedCallbacks: io.github.krhrtky.faktory.core.CallbackRegistry<T> = DefaultCallbackRegistry<T>()
