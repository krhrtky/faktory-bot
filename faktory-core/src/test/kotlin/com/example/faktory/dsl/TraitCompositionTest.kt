...
class TraitCompositionTest {
    ...
    fun `trait can include another trait`() {
        ...
        val trait = (definition as com.example.faktory.core.DefaultFactoryDefinition).traits["premium"]
    ...
    fun `trait composition detects circular references`() {
        ...
        assertThrows<com.example.faktory.core.CircularTraitReferenceException> {
