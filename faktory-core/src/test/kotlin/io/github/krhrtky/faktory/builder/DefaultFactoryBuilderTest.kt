        ...
        val definition =
            DefaultFactoryDefinition(
                ...
                attributes =
                    mapOf(
                        "name" to
                            io.github.krhrtky.faktory.core.DynamicAttribute { _ ->
                                "Dynamic User ${++counter}"
                            },
                        "email" to io.github.krhrtky.faktory.core.StaticAttribute("test@example.com"),
                    ),
            )
    ...
    fun `build evaluates sequence attributes`() {
        val definition =
            DefaultFactoryDefinition(
                ...
                attributes =
                    mapOf(
                        "name" to io.github.krhrtky.faktory.core.StaticAttribute("User"),
                        "email" to io.github.krhrtky.faktory.core.SequenceAttribute(null) { n -> "user$n@example.com" },
                    ),
            )
